...
const char* ssid = "SimUServe_ButtonBox3b";
String st;
...
/*
 * Checks to see if there is a current WiFi connection
 */
bool testWifi() {
  int c = 0;
...
bool checkEepromForValue(int startOffset, int length, char* foundValue)
{
  String value;
